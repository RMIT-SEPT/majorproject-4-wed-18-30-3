...
function App() {
  return (
    ...
    <div className="App">
      ...
      <Route exact path="/admin_set_availabilities" component={AdminSetAvailabilities}/>
      <Route exact path="/admin_set_availabilities_reset" component={AdminSetAvailabilities}/>
