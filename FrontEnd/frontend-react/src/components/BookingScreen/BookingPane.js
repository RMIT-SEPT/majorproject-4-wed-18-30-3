...
import makeAnimated from 'react-select/animated';
    ...
    async function createBooking(newBooking) {
        ...
        return await axios.post('http://ec2-3-88-187-110.compute-1.amazonaws.com:8080/api/booking', {
            id: newBooking.id,
    ...
    async function getTimeslots() {
        return await axios.get('http://ec2-3-88-187-110.compute-1.amazonaws.com:8080/api/timeslot/all').then(response => {
    ...
    async function getBookings() {
        return await axios.get('http://ec2-3-88-187-110.compute-1.amazonaws.com:8080/api/booking/all').then(response => {
            return response.data
        })
    }
    ...
    async function getWorkers() {
        return await axios.get('http://ec2-3-88-187-110.compute-1.amazonaws.com:8080/api/worker/all').then(response => {
            return response.data
        })
    }
